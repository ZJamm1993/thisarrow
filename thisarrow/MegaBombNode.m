...
-(void)disappear
{
    ...
    spark.alpha=0;
    SKAction* sp_show=[SKAction sequence:[NSArray arrayWithObjects:[SKAction fadeAlphaTo:0.8 duration:0.25],[SKAction group:[NSArray arrayWithObjects:[SKAction scaleTo:0.1 duration:0.5],[SKAction fadeAlphaTo:0 duration:0.5], nil]], nil]];
